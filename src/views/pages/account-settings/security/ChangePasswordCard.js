...
const ChangePasswordCard = () => {
  ...
  const ChangePasswordSchema = yup.object().shape({
    currentPassword: yup.string().required(translate('password_is_required')),
    newPassword: yup.string().required(translate('password_is_required')),
    confirmNewPassword: yup.string().required(translate('password_is_required')),
  });
  ...
  const onSubmit = async (e) => {
    try {
      ...
      const response = await API_AUTH.changePassword(e.currentPassword, e.newPassword);
