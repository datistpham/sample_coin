...
import Active2FADialog from 'src/pages/pages/account-settings/twofa'
...
const UserDropdown = props => {
  ...
  const [isOpen2FA, setOpen2FA] = useState(false);
  ...
  return (
    <Fragment>
      <Active2FADialog isOpen={isOpen2FA} setIsOpen={setOpen2FA} />
      <Badge
        overlap='circular'
